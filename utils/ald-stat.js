!function () {
    var t = "5.4.1", a = "log", e = require("./ald-stat-conf.js"), s = 0, n = 0, o = 0, r = 0;
    ...
    var c = function (t) {
        ...
        var r = { ak: e.app_key, uu: _(a), at: a.aldstat_access_token, st: Date.now(), tp: n, ev: s, v: t };
        o && (r.ct = o), a.aldstat_qr && (r.qr = a.aldstat_qr), u(r, "GET", "d.html")
    }, f = function (a, s, n, o) {
        ...
        o && (r.ct = o), a.aldstat_location_name && (r.ln = a.aldstat_location_name), a.aldstat_src && (r.sr = a.aldstat_src), a.aldstat_qr && (r.qr = a.aldstat_qr), u(r, "GET", "d.html")
    };
    ...
    h.prototype.debug = function (t) {
        ...
        if (!q(t)) return !1;
        if ("object" == typeof a) A(a) && f(this.app, "event", t, JSON.stringify(a)); else if ("string" == typeof a && a.length <= 255) {
            if (q(a)) {
                var e = String(a), s = new Object;
                s[e] = a, f(this.app, "event", t, a)
            }
        } else f(this.app, "event", t, !1)
    };
    var g = function () {
        var t = this;
        t.aldstat_duration += Date.now() - t.aldstat_showtime, m(t, "app", "unLaunch")
    }, w = function (t, a, e) {
        "undefined" != typeof wx.getShareInfo ? wx.getShareInfo({
            shareTicket: a, success: function (a) {
        ...
        p ? p > 0 && "number" == typeof p && (n.aldstat_access_token = "" + Date.now() + Math.floor(1e7 * Math.random())) : n.aldstat_access_token = "" + Date.now() + Math.floor(1e7 * Math.random()), m(n, "app", "launch")
    }, y = function (t, a) {
        var e = getApp();
        "undefined" == typeof this.aldstat_error_count ? this.aldstat_error_count = 1 : this.aldstat_error_count++ , f(e, "event", "ald_error_message", JSON.stringify(t))
    }, m = function (a, s, d) {
        var i = wx.getStorageSync("app_" + d + "_upload");
        if (!(!i && "launch" !== d || 1 > i && "number" == typeof i)) {
        ...
        a && a > 0 && "number" == typeof a && (this.aldstat_access_token = "" + Date.now() + Math.floor(1e7 * Math.random())), this.aldstat_duration += Date.now() - this.aldstat_showtime, m(this, "app", "show"), "undefined" != typeof t && ("undefined" != typeof t.shareTicket ? w(this, t.shareTicket, "click") : "undefined" != typeof t.query && "undefined" != typeof t.query.ald_share_src && w(this, "0", "click"))
    }, x = function (t, a) {
        var e = this;
        e.aldstat_is_first_open && (e.aldstat_is_first_open = !1), e.aldstat_duration += Date.now() - e.aldstat_showtime, m(e, "app", "hide")
    }, k = App;
    App = function (t) {
        console.log(t);
        console.log(v);
    ...
    function q(t) {
        ...
        return /^(?!_)(?!.*?_$)[a-zA-Z0-9_\-\u4e00-\u9fa5]+$/.test(a) ? !0 : !1
    }

    function A(t) {
        for (var a in t) {
            if ("object" == typeof t[a]) return !1;
            if ("string" === a) return q(a);
            if ("string" == typeof t[a]) return q(t[a])
        }
        return !0
    }
    ...
    var T = function (t, a) {
        ...
        var s = this, n = getApp();
        if (console.log(t[1]), "undefined" != typeof t && "undefined" != typeof t[1]) {
            var o = wx.getStorageSync("aldstat_uuid"), r = wx.getStorageSync(o), _ = "";
            if ("undefined" !== n.ald_share_src && n.ald_share_src) {
                _ = n.ald_share_src;
                var d = _.split(",");
                d.length >= 3 && (d.shift(), _ = d.toString()), "" !== _ && (_ = _ + "," + o)
            } else _ = wx.getStorageSync("aldstat_uuid");
            t[1].path && "undefined" !== t[1].path || (t[1].path = e.defaultPath ? e.defaultPath : s.__route__), t[1].path += -1 != t[1].path.indexOf("?") ? "&ald_share_src=" + _ : "?ald_share_src=" + _, f(n, "event", "ald_share_chain", {
                path: n.aldstat_last_page,
                chain: _
            }), "" === r || "undefined" == typeof r ? (wx.setStorageSync(o, 1), r = 1, n.page_share_count = r) : (r = parseInt(wx.getStorageSync(o)) + 1, n.page_share_count = r, wx.setStorageSync(o, r)), ("undefined" == typeof e.getShareUserInfo || e.getShareUserInfo === !0) && c(function (t) {
                var a = wx.getStorageSync("aldstat_uuid");
                t.userInfo.uu = a, u(t.userInfo, "GET", "u.html")
            });
            var i = t[1];
            "undefined" == typeof t[1].success && (t[1].success = function (t) {
            }), "undefined" == typeof t[1].fail && (t[1].fail = function (t) {
            });
            var l = t[1].fail, p = t[1].success;
            return t[1].success = function (t) {
                var a = new Array;
                if ("object" == typeof t.shareTickets) for (var e = 0; e < t.shareTickets.length; e++) w(n, t.shareTickets[e], "user");
                f(n, "event", "ald_share_status", JSON.stringify(t)), p(t)
            }, t[1].fail = function (t) {
        ...
        var a = new Object;
        if (-1 != t.indexOf("?")) for (var e = t.split("?")[1], s = e.split("&"), n = 0; n < s.length; n++) a[s[n].split("=")[0]] = unescape(s[n].split("=")[1]); else a = t;
        return a
    };
    Page = function (t) {
